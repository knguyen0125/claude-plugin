...
| Agent | Preferred Agent | Model | Focus | Required Tools |
|-------|-|-------|-------|----------------|
...
| Security Specialist | product:web-security-engineer | opus | Vulnerability Assessment, Compliance, data protection, risks | - |
| UI/UX Specialist | product:ui-ux-specialist | opus | Usability, adoption, accessibility | - |
...
| ML/AI Engineer | product:ml-ai-engineer | opus | Only if AI/ML is involved | - |
